...
// 변경 내용을 테이블에 저장함
mysql_query("update $board set writer='$writer', passwd='$passwd', topic='$topic', content='$content', hit=$hit, wdate='$wdate', space=$space, filename='$userfile_name', filesize='$userfile_size' where id=$id", $con);
