...
echo("<center>
	...
	<tr><td align=center><h1>공지사항</h1></td></tr>
	</table>
...
echo ("
	...
	<a href=pass4.php?board=$board&id=$id&mode=0><img src='change.png' width=25 height=25>&nbsp;</a> 
	<a href=pass4.php?board=$board&id=$id&mode=1><img src='delete.png' width=25 height=25>&nbsp;</a> 
	<a href=reply4.php?board=$board&id=$id><img src='qna.png' width=25 height=25>&nbsp;</a> 
...
<?
	...
	$result =   mysql_query("select * from adminboardreply where id=$id", $con);
			...
			echo ("
				<table border=1 width=900>
					<tr height=70>
						...
						<td width=100 align=center><a href=rpass4.php?board=$board&id=$id&mode=0&wdate=$wdate>수정</a> | <a href=rpass4.php?board=$board&id=$id&mode=1&wdate=$wdate>삭제</a></td>
					</tr>
				</table>
	...
	echo ("
		<br>
		<form action=memo4.php?board=$board&id=$id method=post>
	...
	if ($ppid != $pid) {
		...
		echo ("
			...
			<a href=content4.php?board=$board&id=$pid>&nbsp;&nbsp;이전글 &nbsp;▲ &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$ptopic</a>
			</td>
			</tr>
			</table>
	");
	...
	if ($aaid != $aid) {
		...
		echo ("
			<td style='padding:15px;'>
			<a href=content4.php?board=$board&id=$aid>&nbsp;&nbsp;다음글 &nbsp;▼ &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$atopic</a>
			</td>
			</tr>
			</table>
		");
...
if (!$total){
	...
	while($counter<$pagesize):
		...
		$result2 = mysql_query("select * from adminboardreply where id=$aid", $con);
		...
		if ($id == $aid) {
			if (!$filename) {
				if (!$total2) {
					...
					<td align=left style='padding:10px;'>$t<a href=content4.php?board=$board&id=$aid>$topic</a></td>
					...
					<tr bgcolor=#B3B9C4><td align=center style='padding:10px;'>→ $aid</td>
					<td align=center style='padding:10px;'>$writer</td>
					<td align=left style='padding:10px;'>$t<a href=content4.php?board=$board&id=$aid>$topic [$total2]</a></td>
					<td align=center style='padding:10px;'>$wdate</td><td align=center style='padding:10px;'>$hit</td>
					</tr>
					");
				}
				...
				if (!$total2) {
					...
					<tr bgcolor=#B3B9C4><td align=center style='padding:10px;'>→ $aid</td>
					<td align=center style='padding:10px;'>$writer</td>
					<td align=left style='padding:10px;'>$t<a href=content4.php?board=$board&id=$aid>$topic <img width=15 height=15 src='floppy2.png'/></a></td>
					<td align=center style='padding:10px;'>$wdate</td><td align=center style='padding:10px;'>$hit</td>
					</tr>
					");
				} else {
					...
					<tr bgcolor=#B3B9C4><td align=center style='padding:10px;'>→ $aid</td>
					<td align=center style='padding:10px;'>$writer</td>
					<td align=left style='padding:10px;'>$t<a href=content4.php?board=$board&id=$aid>$topic [$total2] <img width=15 height=15 src='floppy2.png'/></a></td>
					<td align=center style='padding:10px;'>$wdate</td><td align=center style='padding:10px;'>$hit</td>
					</tr>
					");
				}
			...
			if (!$filename) {
				if (!$total2) {
					echo("
						...
						<td align=center style='padding:10px;'>$writer</td>
						<td align=left style='padding:10px;'>$t<a href=content4.php?board=$board&id=$aid onmouseover=\"this.style.color='white';\" onmouseout=\"this.style.color='blue';\">$topic</a></td>
						<td align=center style='padding:10px;'>$wdate</td><td align=center style='padding:10px;'>$hit</td>
						</tr>
					");
				} else {
					echo("
						<tr onmouseover=\"this.style.color='white'; this.style.background='#BDBDBD';\" onmouseout=\"this.style.color='black';this.style.background='';\"><td align=center style='padding:10px;'>$aid</td>
						<td align=center style='padding:10px;'>$writer</td>
						<td align=left style='padding:10px;'>$t<a href=content4.php?board=$board&id=$aid onmouseover=\"this.style.color='white';\" onmouseout=\"this.style.color='blue';\">$topic [$total2]</a></td>
						<td align=center style='padding:10px;'>$wdate</td><td align=center style='padding:10px;'>$hit</td>
						</tr>
					");
				}
				...
				if (!$total2) {
					echo("
						<tr onmouseover=\"this.style.color='white'; this.style.background='#BDBDBD';\" onmouseout=\"this.style.color='black';this.style.background='';\"><td align=center style='padding:10px;'>$aid</td>
						<td align=center style='padding:10px;'>$writer</td>
						<td align=left style='padding:10px;'>$t<a href=content4.php?board=$board&id=$aid onmouseover=\"this.style.color='white';\" onmouseout=\"this.style.color='blue';\">$topic <img width=15 height=15 src='floppy2.png'/></a></td>
						<td align=center style='padding:10px;'>$wdate</td><td align=center style='padding:10px;'>$hit</td>
						</tr>
					");
				} else {
					echo("
						<tr onmouseover=\"this.style.color='white'; this.style.background='#BDBDBD';\" onmouseout=\"this.style.color='black';this.style.background='';\"><td align=center style='padding:10px;'>$aid</td>
						<td align=center style='padding:10px;'>$writer</td>
						<td align=left style='padding:10px;'>$t<a href=content4.php?board=$board&id=$aid onmouseover=\"this.style.color='white';\" onmouseout=\"this.style.color='blue';\">$topic [$total2] <img width=15 height=15 src='floppy2.png'/></a></td>
						<td align=center style='padding:10px;'>$wdate</td><td align=center style='padding:10px;'>$hit</td>
						</tr>
					");
				}
	...
	if ($pblock > 0 && $cpage != 1) {
			echo ("
				...
				<form action=show4.php?board=$board&cblock=$pblock&cpage=1 method=post>
	...
	if ($pblock > 0)        // 이전 블록이 존재하면 [이전블록] 버튼을 활성화
		echo ("
			<td align=center width=70>
			<form action=show4.php?board=$board&cblock=$pblock&cpage=$pstartpage method=post>
				<input type=submit value='<' name=pstartpage
				onmouseover=\"this.style.color='white'; this.style.background='#BDBDBD';\" onmouseout=\"this.style.color='black';this.style.background='';\"
				style='width:40; height:40; border-style:solid; border-width:1px;'>
			</form>
	...
	while($i < $nstartpage):
	   ...
	   echo ("
			...
			<form action=show4.php?board=$board&cblock=$cblock&cpage=$i method=post>
		");
		if ($i == $cpage) {
			echo ("
	...
	if ($nstartpage <= $totalpage)   
		echo ("
			...
			<form action=show4.php?board=$board&cblock=$nblock&cpage=$nstartpage method=post>
	...
	if ($nstartpage <= $totalpage && $cpage!=$totalpage) {
			echo ("
				<td align=center width=70>
				<form action=show4.php?board=$board&cblock=$nblock&cpage=$totalpage method=post>
	...
	echo ("</tr><tr><td height=30></td></tr></table></center>");
}
