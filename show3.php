...
echo("
	...
	<tr><td colspan=2 align=center><h1>고객 게시판</h1></td></tr>
	<tr><td align=right>
	<form method=post action=search3.php?board=$board>
...
if (!$total){
	...
	while($counter<$pagesize):
		...
		$result2 = mysql_query("select * from customerboardreply where id=$id", $con);
		...
		if (!$filename) {
			if (!$total2) {
				echo("
					...
					<td align=left style='padding:10px;border-left:none; border-right:none;'>$t<a href=content3.php?board=$board&id=$id&cpage=$cpage onmouseover=\"this.style.color='white';\" onmouseout=\"this.style.color='blue';\">$topic</a></td>
				...
				echo("
					...
					<td align=center style='padding:10px;border-left:none; border-right:none;'>$id</td>
					<td align=center style='padding:10px;border-left:none; border-right:none;'>$writer</td>
					<td align=left style='padding:10px;border-left:none; border-right:none;'>$t<a href=content3.php?board=$board&id=$id&cpage=$cpage onmouseover=\"this.style.color='white';\" onmouseout=\"this.style.color='blue';\">$topic [$total2]</a></td>
					<td align=center style='padding:10px;border-left:none; border-right:none;'>$wdate</td><td align=center style='border-left:none; border-right:none;'>$hit</td>
					</tr>
				");
			}
			...
			if (!$total2) {
				echo("
					...
					<td align=left style='padding:10px;'>$t<a href=content3.php?board=$board&id=$id&cpage=$cpage onmouseover=\"this.style.color='white';\" onmouseout=\"this.style.color='blue';\">$topic <img width=15 height=15 src='floppy2.png'/></a></td>
				...
				echo("
					<tr onmouseover=\"this.style.color='white'; this.style.background='#BDBDBD';\" onmouseout=\"this.style.color='black';this.style.background='';\"><td align=center style='padding:10px;'>$id</td>
					<td align=center style='padding:10px;border-left:none; border-right:none;'>$writer</td>
					<td align=left style='padding:10px;'>$t<a href=content3.php?board=$board&id=$id&cpage=$cpage onmouseover=\"this.style.color='white';\" onmouseout=\"this.style.color='blue';\">$topic [$total2] <img width=15 height=15 src='floppy2.png'/></a></td>
