...
<tr><td ><font size=6><b>쇼핑 카트(&nbsp;$total&nbsp;)</b></td></tr>
<tr><td align=right><font size=2><b>$UserName</b>님의 현재 쇼핑 카트 내용</td>
</table>
");
...
echo ("
	...
	<td width=50 align=center style='border-left:none; border-right:none;'><font size=2 color=white>삭제</td></tr>
");

if (!$total) {
     echo("<tr><td colspan=10 align=center><font size=2>쇼핑백에 담긴 상품이 없습니다.</td></tr></table>");
} else {
    ...
    while ($counter < $total) :
	   ...
	   $totalpoint = $totalpoint + $subtotalpoint;
		echo ("<tr onmouseover=\"this.style.color='white'; this.style.background='#BDBDBD';\" onmouseout=\"this.style.color='black';this.style.background='';\"><td align=center style='border-left:none; border-right:none;'>
			...
			<td align=center style='border-left:none; border-right:none;'></form>
			<a href=itemdelete.php?pcode=$pcode><img src='delete.png' width=20 height=20></a>
			<form method=post action=bagprocess.php?id=$id&session=$session&pcode=$pcode&quantity=$quantity><input type=submit value=찜하기></form>
			");
...
echo ("<table width=900 border=0>
	...
	<tr><td width=400></td><td align=right valign=top><font size=2><form method=post action=buy.php?mode=1><input type=submit value=구매결정 style='padding-top:10px;padding-bottom:10px;padding-left:38px;padding-right:38px;'></form></td>
	...
	<td align=right valign=top><form method=post action=showheart.php><input type=submit value='찜한 목록 보기' style='padding-top:10px;padding-bottom:10px;padding-left:23px;padding-right:23px;'></form></td>
	<tr></tr></table>");
