...
echo ("
	<center>
	<font size=2><b>$key</b>으로 검색한 결과입니다. 우편번호를 누르면 선택됩니다
...
while($i <   $total):
	...
	echo ("<tr onmouseover=\"this.style.color='white'; this.style.background='#BDBDBD';\" onmouseout=\"this.style.color='black';this.style.background='';\"><td><font size=2>&nbsp;<a href=\"javascript: okzip('$zip',   '$address')\" style='text-decoration:none; color:black;'>$zip</a>&nbsp;&nbsp;&nbsp;&nbsp;$sido   $gugun $dong $bunji </td></tr>");
