...
echo ("
	<script>
		window.alert('$totaltotalprice 원 입금 부탁드립니다.')
...
mysql_query("delete from heart   where session='$Session'",$con);
...
mysql_query("update member set point=$totalpoint where uid='$id'", $con);
mysql_close($con);	 
...
echo ("<script>
    ...
    <meta http-equiv='Refresh' content='0; url=completebuy.php?ordernum=$ordernum&quantity=$quantity&totalpoint=$totalpoint&totalprice=$totalprice&subpoint=$subpoint'>
");
	break;
